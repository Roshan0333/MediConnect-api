...
app.use("/appointment/management/auth", require("./Route/ManagementAuthRoute"));
app.use("/appointment/management/Report", require("./Route/ReportRoute"));
app.use("/appointment/SearchBy", require("./Route/End_UserRoute/Search"));
